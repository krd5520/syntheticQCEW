...
class microdataConfig:
    ...
    GAM_SCALE = 200
    NUM_CHUNK = 35
    OUTPATH = "DataDiag/PythonMicrodataSubsets/"
...
def get_establishments_from_one_naics6(naics6row,gamma_shape=microdataConfig.GAM_SHAPE,gamma_scale=microdataConfig.GAM_SCALE,noisecoef=1.69):
